...
int main(int argc, char* argv[])
{
    try {
        ...
        ("behavior,b", po::value<std::string>()->default_value("../etc/lampe/behavior.yaml"), "Configuration file of the tasks (yaml) [default: ../etc/franka/circular_cartesian.yam]")
        ...
        ("controller,c", po::value<std::string>()->default_value("../etc/lampe/controller.yaml"), "Configuration file of the tasks (yaml) [default: ../etc/franka/pos_tracker.yaml]")
    ...
    std::cout << "--------------------------" << std::endl;
        ...
        std::string urdf = "lampe/lampe.urdf";
        auto robot = std::make_shared<robot_dart::Robot>(urdf);
        robot->fix_to_world();
        ...
        controller_config["CONTROLLER"]["base_path"] = "../etc/lampe"; // we assume that we run in ./build
